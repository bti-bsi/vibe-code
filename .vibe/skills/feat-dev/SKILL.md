---
name: feat-dev
description: End-to-end workflow for implementing a non-trivial vibe-code
...
Use this workflow when implementing a feature in vibe-code that needs design,
...
Use `.vibe/` paths for planning artifacts:

- `.vibe/design/<feature>.md`
- `.vibe/e2e-tests/<feature>.md`

## Phase 1: Investigate

Understand the requested behavior and the current vibe-code implementation.
