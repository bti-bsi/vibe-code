...
A short vibe-code case to illustrate two failure modes from `SKILL.md`:
...
`~/.vibe/logs` shows the model returned proper text. Stdout was empty.
...
Fix commit: vibe-code `feadf052f` — `fix(cli): append newline to text-mode
