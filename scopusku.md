...
```
                       ...
                       +----------+----------+
                          ...
                          Visual Feature Vector
                                  |
+---------------------+           |           +------------------------+
|   Input Data Iklim  |           |           | Output: Kelas Penyakit |
|   (7 days time-     |           |           +------------------------+
|    series)          |           |                        ^
+----------+----------+           |                        |
           |                      |                        |
+----------+----------+           |     +------------------+---+
|   LSTM / Times-     +-----------+----->   Multi-Head Fusion   |
|   Former            |  Climate |     |   Cross-Attention      |
+----------+----------+  Feature  |     +----------+------------+
           |                      |                |
...
1. **Dataset multimodal** pertama untuk penyakit pisang — citra + iklim + spasial — akan dipublikasikan secara *open-access*
