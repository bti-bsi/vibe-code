...
This release includes updates to the Vibe Code Java SDK with improved session management, enhanced transport options, and better error handling capabilities.
...
```gradle
implementation 'com.alibaba:vibecode-sdk:0.0.1-alpha'
```
...
3. **Extended API Coverage**: More comprehensive coverage of Vibe Code CLI features
