package com.alibaba.vibe.code.cli.example;
...
import com.alibaba.vibe.code.cli.protocol.message.assistant.block.TextBlock;
...
public class SessionExample {
    ...
    public static void runSetModelExample(Session session) {
        try {
            ...
            Optional<Boolean> modelChangeResult = session.setModel("vibe3-coder-flash");
            ...
            Optional<Boolean> modelChangeResult2 = session.setModel("vibe3-coder-plus");
