package com.alibaba.vibe.code.cli.session.event.consumers;
...
import com.alibaba.vibe.code.cli.protocol.data.behavior.Allow;
import com.alibaba.vibe.code.cli.protocol.data.behavior.Behavior;
...
import com.alibaba.vibe.code.cli.protocol.message.assistant.block.ContentBlock;
import com.alibaba.vibe.code.cli.protocol.message.assistant.event.ContentBlockDeltaEvent;
import com.alibaba.vibe.code.cli.protocol.message.assistant.event.StreamEvent;
import com.alibaba.vibe.code.cli.protocol.message.control.payload.CLIControlPermissionRequest;
import com.alibaba.vibe.code.cli.protocol.message.control.payload.CLIControlPermissionResponse;
...
import com.alibaba.vibe.code.cli.session.Session;
...
public class SessionEventSimpleConsumers implements SessionEventConsumers {
     ...
     *
     * @param session a {@link com.alibaba.vibe.code.cli.session.Session} object.
     * @param assistantContent a {@link com.alibaba.vibe.code.cli.protocol.data.AssistantContent} object.
     */
