package com.alibaba.vibe.code.cli.protocol.message;
...
public class SDKSystemMessage extends MessageBase {
     ...
     * Vibe Code version.
     */
    @JSONField(name = "vibe_code_version")
    private String vibeCodeVersion;
    /**
     * Output style.
     */
    ...
    /**
     * Gets the Vibe Code version.
     *
     * @return The Vibe Code version
     */
    public String getVibeCodeVersion() {
        return vibeCodeVersion;
    }

    /**
     * Sets the Vibe Code version.
     *
     * @param vibeCodeVersion The Vibe Code version
     */
    public void setVibeCodeVersion(String vibeCodeVersion) {
        this.vibeCodeVersion = vibeCodeVersion;
    }
