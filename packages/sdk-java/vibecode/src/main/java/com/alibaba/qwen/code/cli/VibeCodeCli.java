...
import com.alibaba.vibe.code.cli.session.event.consumers.AssistantContentConsumers;
...
import com.alibaba.vibe.code.cli.transport.process.ProcessTransport;
...
/**
 * Main entry point for interacting with the Vibe Code CLI. Provides static methods for simple queries and session management.
 *
 * @author skyfire
 * @version $Id: 0.0.1
 */
public class VibeCodeCli {
    private static final Logger log = LoggerFactory.getLogger(VibeCodeCli.class);

    /**
     * Sends a simple query to the Vibe Code CLI and returns a list of responses.
     *
