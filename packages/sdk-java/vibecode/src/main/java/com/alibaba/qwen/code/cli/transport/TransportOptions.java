package com.alibaba.vibe.code.cli.transport;
...
public class TransportOptions implements Cloneable {
    /**
     * Path to the Vibe executable.
     */
    private String pathToVibeExecutable;
    /**
    ...
    /**
     * Gets the path to the Vibe executable.
     *
     * @return The path to the Vibe executable
     */
    public String getPathToVibeExecutable() {
        return pathToVibeExecutable;
    }

    /**
     * Sets the path to the Vibe executable.
     *
     * @param pathToVibeExecutable The path to the Vibe executable
     * @return This instance for method chaining
     */
    public TransportOptions setPathToVibeExecutable(String pathToVibeExecutable) {
        this.pathToVibeExecutable = pathToVibeExecutable;
        return this;
    }
