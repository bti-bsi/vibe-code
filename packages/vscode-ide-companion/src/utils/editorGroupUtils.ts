...
/**
 * Find the editor group immediately to the left of the Vibe chat webview.
 ...
 * - Uses the webview tab viewType 'mainThreadWebview-vibeCode.chat'.
 */
...
/**
 * Ensure there is an editor group directly to the left of the Vibe chat webview.
