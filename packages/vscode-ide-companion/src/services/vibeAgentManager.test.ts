...
describe('VibeAgentManager.setModelFromUi', () => {
  it('emits the selected model metadata from the available models list', async () => {
    ...
    (
      ...
      {
        modelId: 'vibe3-coder-base',
        name: 'Vibe3 Coder Base',
        _meta: {
          contextLimit: 131072,
        },
      },
...
describe('VibeAgentManager.createNewSession', () => {
