...
> = {
  [ApprovalMode.PLAN]: {
    label: 'Plan mode',
    title: 'Vibe will plan before executing. Click to switch modes.',
    iconType: 'plan',
  },
  [ApprovalMode.DEFAULT]: {
    label: 'Ask before edits',
    title: 'Vibe will ask before each edit. Click to switch modes.',
    iconType: 'edit',
  },
  [ApprovalMode.AUTO_EDIT]: {
    label: 'Edit automatically',
    title: 'Vibe will edit files automatically. Click to switch modes.',
    iconType: 'auto',
  },
  [ApprovalMode.YOLO]: {
    label: 'YOLO',
