...
#### Vibe Code Installation Required

Version 0.1.0 requires [Vibe Code](https://github.com/vibe-bti/vibe-code) **>= 0.4.0** to be installed separately and accessible in your PATH.

```bash
# Install Vibe Code globally
npm install -g vibe-code@^0.4.0
```

**Note**: From version **0.1.1** onwards, the CLI is bundled with the SDK, so no separate Vibe Code installation is needed.
