...
```bash
npm install @vibe-bti/vibe-code-webui
```
...
<html>
  <head>
    ...
    <script src="https://unpkg.com/@vibe-bti/vibe-code-webui@0.1.0-beta.2/dist/index.umd.js"></script>

    <!-- Load the CSS -->
    <link
      rel="stylesheet"
      href="https://unpkg.com/@vibe-bti/vibe-code-webui@0.1.0-beta.2/dist/styles.css"
    />
  </head>
  <body>
    <div id="root"></div>
...
```tsx
import { Button, Input, Tooltip } from '@vibe-bti/vibe-code-webui';
import { PlatformProvider } from '@vibe-bti/vibe-code-webui/context';
...
```tsx
import { Button } from '@vibe-bti/vibe-code-webui';
...
```tsx
import { Input } from '@vibe-bti/vibe-code-webui';
...
```tsx
import { Tooltip } from '@vibe-bti/vibe-code-webui';
...
// tailwind.config.js
module.exports = {
  presets: [require('@vibe-bti/vibe-code-webui/tailwind.preset.cjs')],
  // your customizations
};
```
