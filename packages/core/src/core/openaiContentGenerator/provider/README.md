...
This folder contains the different provider implementations for the Vibe Code refactor system.
...
- `dashscope.ts` - DashScope (Vibe) specific provider implementation
...
The `DashScopeOpenAICompatibleProvider` handles DashScope (Vibe) specific features like cache control and metadata.
