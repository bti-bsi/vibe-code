 ...
 * `isDeepSeekHostname` instead — see https://github.com/vibe-bti/vibe-code/issues/3613.
 */
...
// the API contract is satisfied. https://github.com/vibe-bti/vibe-code/issues/3695
