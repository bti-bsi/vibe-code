...
describe('convertClaudeToVibeConfig', () => {
  it('should convert basic Claude config', () => {
    ...
    const result = convertClaudeToVibeConfig(claudeConfig);
  ...
  it('should throw error for missing name', () => {
    ...
    expect(() => convertClaudeToVibeConfig(invalidConfig)).toThrow();
  });
});
...
describe('convertClaudePluginPackage', () => {
  ...
  it('should successfully convert agent files with Windows CRLF endings', async () => {
    ...
    // Verify: agent file was properly parsed and converted into .vibe/agents folder structure
  ...
  it('should convert hooks from Claude plugin format to Vibe format with variable substitution', async () => {
