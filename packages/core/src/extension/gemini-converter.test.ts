...
describe('convertGeminiToVibeConfig', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should convert basic Gemini config from directory', () => {
    ...
    const result = convertGeminiToVibeConfig(mockDir);
  ...
  it('should throw error for missing name', () => {
    ...
    expect(() => convertGeminiToVibeConfig(mockDir)).toThrow(
