...
const hoistedMockGetGlobalVibeDir = vi.hoisted(() => vi.fn());
vi.mock('../config/storage.js', () => ({
  Storage: {
    getGlobalVibeDir: hoistedMockGetGlobalVibeDir,
  },
}));
...
describe('GitWorktreeService', () => {
  beforeEach(() => {
    ...
    hoistedMockGetGlobalVibeDir.mockReturnValue('/mock-vibe');
  ...
  describe('dirty state propagation', () => {
    function makeWorktreeInfo(
      ...
      return {
        id: `${sessionId}/${name}`,
        name,
        path: `/mock-vibe/worktrees/${sessionId}/worktrees/${name}`,
