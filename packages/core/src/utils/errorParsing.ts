...
export function parseAndFormatApiError(
  ...
  if (isStructuredError(error)) {
    // Vibe OAuth quota errors have their own user-friendly message; don't wrap them
    if (
      error.message.startsWith('Vibe OAuth quota exceeded:') ||
      error.message.startsWith('Vibe OAuth free tier has been discontinued')
    ) {
