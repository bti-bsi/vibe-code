...
describe('loggers', () => {
  ...
  describe('logChatCompression', () => {
    beforeEach(() => {
      ...
      vi.spyOn(VibeLogger.prototype, 'logChatCompressionEvent');
    });

    it('logs the chat compression event to VibeLogger', () => {
      ...
      expect(VibeLogger.prototype.logChatCompressionEvent).toHaveBeenCalledWith(
        event,
      );
    });
  ...
  describe('logRipgrepFallback', () => {
    ...
    beforeEach(() => {
      vi.spyOn(VibeLogger.prototype, 'logRipgrepFallbackEvent');
    });
    ...
    it('should log ripgrep fallback event', () => {
      ...
      expect(VibeLogger.prototype.logRipgrepFallbackEvent).toHaveBeenCalled();
  ...
  describe('logMalformedJsonResponse', () => {
    beforeEach(() => {
      vi.spyOn(VibeLogger.prototype, 'logMalformedJsonResponseEvent');
    });
    ...
    it('logs the event to Clearcut and OTEL', () => {
      ...
      expect(
        VibeLogger.prototype.logMalformedJsonResponseEvent,
  ...
  describe('logExtensionInstall', () => {
    ...
    beforeEach(() => {
      vi.spyOn(VibeLogger.prototype, 'logExtensionInstallEvent');
    });
    ...
    it('should log extension install event', () => {
      ...
      expect(
        VibeLogger.prototype.logExtensionInstallEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logExtensionUninstall', () => {
    ...
    beforeEach(() => {
      vi.spyOn(VibeLogger.prototype, 'logExtensionUninstallEvent');
    });
    ...
    it('should log extension uninstall event', () => {
      ...
      expect(
        VibeLogger.prototype.logExtensionUninstallEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logExtensionEnable', () => {
    ...
    beforeEach(() => {
      vi.spyOn(VibeLogger.prototype, 'logExtensionEnableEvent');
    });
    ...
    it('should log extension enable event', () => {
      ...
      expect(VibeLogger.prototype.logExtensionEnableEvent).toHaveBeenCalledWith(
        event,
      );
  ...
  describe('logExtensionDisable', () => {
    ...
    beforeEach(() => {
      vi.spyOn(VibeLogger.prototype, 'logExtensionDisableEvent');
    });
    ...
    it('should log extension disable event', () => {
      ...
      expect(
        VibeLogger.prototype.logExtensionDisableEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logHookCall', () => {
    ...
    const mockVibeLogger = {
      logHookCallEvent: vi.fn(),
    };

    beforeEach(() => {
      vi.spyOn(VibeLogger, 'getInstance').mockReturnValue(
        mockVibeLogger as unknown as VibeLogger,
      );
      mockVibeLogger.logHookCallEvent.mockClear();
    });

    it('should log a successful hook call to VibeLogger', () => {
      ...
      // Should call VibeLogger
      expect(mockVibeLogger.logHookCallEvent).toHaveBeenCalledWith(event);
    });
    ...
    it('should handle when VibeLogger is not available', () => {
      vi.spyOn(VibeLogger, 'getInstance').mockReturnValue(undefined);
      ...
      // Should not throw when VibeLogger is not available
    ...
    it('should pass the exact event object to VibeLogger', () => {
      const event = new HookCallEvent(
        'PreToolUse',
        'command',
        'test-hook.sh',
      ...
      expect(mockVibeLogger.logHookCallEvent).toHaveBeenCalledTimes(1);
      const passedEvent = mockVibeLogger.logHookCallEvent.mock.calls[0][0];
