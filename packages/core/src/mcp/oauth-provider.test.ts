...
describe('MCPOAuthProvider', () => {
  ...
  describe('Authorization URL building', () => {
    ...
    // Regression test for https://github.com/vibe-bti/vibe-code/issues/1749
    // Scenario: user runs `vibe mcp add --transport http yuque https://mcp.alibaba-inc.com/yuque/mcp`
