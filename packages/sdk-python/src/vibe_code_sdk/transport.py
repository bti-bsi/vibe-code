"""Process transport for vibe CLI stream-json protocol."""
...
def prepare_spawn_info(path_to_vibe_executable: str | None) -> SpawnInfo:
    if path_to_vibe_executable is None:
        return SpawnInfo(command="vibe", args=[])

    spec = path_to_vibe_executable
...
class ProcessTransport:
    ...
    async def start(self) -> None:
        ...
        spawn_info = prepare_spawn_info(self._options.path_to_vibe_executable)
