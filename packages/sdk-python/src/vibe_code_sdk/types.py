"""Public type definitions for vibe_code_sdk."""
...
class QueryOptions:
    cwd: str | None = None
    model: str | None = None
    path_to_vibe_executable: str | None = None
    ...
    def from_mapping(cls, value: Mapping[str, Any] | None) -> QueryOptions:
        ...
        return cls(
            ...
            path_to_vibe_executable=_as_optional_str(data, "path_to_vibe_executable"),
