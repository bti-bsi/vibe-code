...
@pytest.mark.asyncio
async def test_single_turn_query(fake_vibe_path: str) -> None:
    result = query(
        "hello world",
        {
...
@pytest.mark.asyncio
async def test_include_partial_messages(fake_vibe_path: str) -> None:
    result = query(
        "stream partial",
        {
            "path_to_vibe_executable": fake_vibe_path,
...
@pytest.mark.asyncio
async def test_default_permission_callback_denies_tool_use(fake_vibe_path: str) -> None:
    result = query(
        "use tool now",
        {
            "path_to_vibe_executable": fake_vibe_path,
...
@pytest.mark.asyncio
async def test_permission_callback_can_allow_tool_use(fake_vibe_path: str) -> None:
...
@pytest.mark.asyncio
async def test_unknown_control_requests_are_rejected(fake_vibe_path: str) -> None:
    result = query(
...
@pytest.mark.asyncio
async def test_dynamic_controls_and_status(fake_vibe_path: str) -> None:
...
@pytest.mark.asyncio
async def test_session_id_resume_and_continue(fake_vibe_path: str) -> None:
    explicit = query(
        "hello explicit",
        {
            "path_to_vibe_executable": fake_vibe_path,
...
@pytest.mark.asyncio
async def test_non_zero_process_exit_is_propagated(fake_vibe_path: str) -> None:
    result = query(
        "please exit nonzero",
        {
            "path_to_vibe_executable": fake_vibe_path,
...
@pytest.mark.asyncio
async def test_async_context_manager(fake_vibe_path: str) -> None:
    async with query(
        "hello context",
        {
            "path_to_vibe_executable": fake_vibe_path,
