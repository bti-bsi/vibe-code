...
import pytest
from vibe_code_sdk.errors import AbortError, ControlRequestTimeoutError
from vibe_code_sdk.json_lines import parse_json_line
from vibe_code_sdk.query import Query
...
def test_sync_next_after_exhaustion_raises_stop_iteration() -> None:
    ...
    from vibe_code_sdk.sync_query import _STOP, SyncQuery
