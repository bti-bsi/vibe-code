...
import pytest
from vibe_code_sdk.errors import ValidationError
from vibe_code_sdk.types import QueryOptions, TimeoutOptions
from vibe_code_sdk.validation import validate_query_options
...
def test_rejects_empty_vibe_executable_path() -> None:
    with pytest.raises(
        ValidationError, match="path_to_vibe_executable cannot be empty"
    ):
        validate_query_options(QueryOptions(path_to_vibe_executable="   "))
