...
import { FatalConfigError, ideContextStore } from '@vibe-bti/vibe-code-core';
import {
  describe,
  it,
  expect,
...
describe('Trusted Folders Loading', () => {
  ...
  it('should use VIBE_CODE_TRUSTED_FOLDERS_PATH env var if set', () => {
    const customPath = '/custom/path/to/trusted_folders.json';
    process.env['VIBE_CODE_TRUSTED_FOLDERS_PATH'] = customPath;
    ...
    delete process.env['VIBE_CODE_TRUSTED_FOLDERS_PATH'];
  });
