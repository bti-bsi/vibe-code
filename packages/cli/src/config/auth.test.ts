...
describe('validateAuthMethod', () => {
  ...
  it('should return an error for VIBE_OAUTH (free tier discontinued)', () => {
    const result = validateAuthMethod(AuthType.VIBE_OAUTH);
  ...
  it('should use config.getModelsConfig().getModel() when Config is provided', () => {
    ...
    } as unknown as import('@vibe-bti/vibe-code-core').Config;
