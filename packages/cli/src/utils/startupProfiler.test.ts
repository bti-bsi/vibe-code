...
describe('startupProfiler', () => {
  ...
  beforeEach(() => {
    resetStartupProfiler();
    vi.restoreAllMocks();
    saveEnv('VIBE_CODE_PROFILE_STARTUP', 'SANDBOX');
    delete process.env['VIBE_CODE_PROFILE_STARTUP'];
  ...
  function enableProfiler() {
    process.env['VIBE_CODE_PROFILE_STARTUP'] = '1';
  ...
  describe('when outside sandbox (SANDBOX not set)', () => {
    it('should not enable profiler even with VIBE_CODE_PROFILE_STARTUP=1', () => {
      process.env['VIBE_CODE_PROFILE_STARTUP'] = '1';
      delete process.env['SANDBOX'];
  ...
  describe('when enabled (VIBE_CODE_PROFILE_STARTUP=1 + SANDBOX)', () => {
    beforeEach(() => {
      enableProfiler();
    });
