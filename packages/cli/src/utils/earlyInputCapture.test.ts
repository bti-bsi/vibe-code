...
describe('earlyInputCapture', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env['VIBE_CODE_DISABLE_EARLY_CAPTURE'];
  });
  ...
  describe('edge cases', () => {
    ...
    it('should skip when VIBE_CODE_DISABLE_EARLY_CAPTURE is set', () => {
      process.env['VIBE_CODE_DISABLE_EARLY_CAPTURE'] = '1';
      startEarlyInputCapture();
      mockStdin.write(Buffer.from('a'));
      stopEarlyInputCapture();
