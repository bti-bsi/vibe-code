 ...
 * This file handles the creation and maintenance of ~/.vibe/output-language.md
...
const LLM_OUTPUT_LANGUAGE_MARKER_PREFIX = 'vibe-code:llm-output-language:';
...
/**
 * Returns the path to the LLM output language rule file (~/.vibe/output-language.md).
 */
...
function parseOutputLanguageFromContent(content: string): string | null {
  // Primary: machine-readable marker (e.g., <!-- vibe-code:llm-output-language: 中文 -->)
