...
// German translations for Vibe Code CLI
// Deutsche Übersetzungen für Vibe Code CLI
...
export default {
  ...
  'Analyzes the project and creates a tailored VIBE.md file.':
    'Analysiert das Projekt und erstellt eine maßgeschneiderte VIBE.md-Datei.',
  'List available Vibe Code tools. Usage: /tools [desc]':
    'Verfügbare Vibe Code Werkzeuge auflisten. Verwendung: /tools [desc]',
  'List available skills.': 'Verfügbare Skills auflisten.',
  'Available Vibe Code CLI tools:': 'Verfügbare Vibe Code CLI-Werkzeuge:',
  ...
  'open full Vibe Code documentation in your browser':
    'Vollständige Vibe Code Dokumentation im Browser öffnen',
  ...
  // ============================================================================
  'Project Level (.vibe/agents/)': 'Projektebene (.vibe/agents/)',
  'User Level (~/.vibe/agents/)': 'Benutzerebene (~/.vibe/agents/)',
  ...
  'Generate with Vibe Code (Recommended)':
    'Mit Vibe Code generieren (Empfohlen)',
  ...
  'View and edit Vibe Code settings':
    'Vibe Code Einstellungen anzeigen und bearbeiten',
  Settings: 'Einstellungen',
  'To see changes, Vibe Code must be restarted. Press r to exit and apply changes now.':
    'Um Änderungen zu sehen, muss Vibe Code neu gestartet werden. Drücken Sie r, um jetzt zu beenden und Änderungen anzuwenden.',
  ...
  'How is Vibe doing this session? (optional)':
    'Wie macht sich Vibe in dieser Sitzung? (optional)',
  Bad: 'Schlecht',
  Fine: 'In Ordnung',
  Good: 'Gut',
  Dismiss: 'Ignorieren',
  ...
  'Respect .vibeignore': '.vibeignore beachten',
  ...
  'This extension will append info to your VIBE.md context using {{fileName}}':
    'Diese Erweiterung wird Informationen zu Ihrem VIBE.md-Kontext mit {{fileName}} hinzufügen',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Vibe Code.':
    'Sie installieren eine Erweiterung von {{originSource}}. Einige Funktionen funktionieren möglicherweise nicht perfekt mit Vibe Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Vibe Code in one of these supported IDEs: VS Code or VS Code forks.':
    'IDE-Integration wird in Ihrer aktuellen Umgebung nicht unterstützt. Um diese Funktion zu nutzen, führen Sie Vibe Code in einer dieser unterstützten IDEs aus: VS Code oder VS Code-Forks.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage Vibe Code hooks': 'Vibe Code-Hooks verwalten',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Vibe Code.':
    'Dieses Menü ist schreibgeschützt. Um Hooks hinzuzufügen oder zu ändern, bearbeiten Sie settings.json direkt oder fragen Sie Vibe Code.',
  ...
  'To add hooks, edit settings.json directly or ask Vibe.':
    'Um Hooks hinzuzufügen, bearbeiten Sie settings.json direkt oder fragen Sie Vibe.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask Vibe to help.':
    'Um diesen Hook zu ändern oder zu entfernen, bearbeiten Sie settings.json direkt oder fragen Sie Vibe.',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Vibe Code.':
    'Um Hooks wieder zu aktivieren, entfernen Sie "disableAllHooks" aus settings.json oder fragen Sie Vibe Code.',
  // Hooks - Source
  Project: 'Projekt',
  User: 'Benutzer',
  System: 'System',
  ...
  'Right before Vibe Code concludes its response':
    'Direkt bevor Vibe Code seine Antwort abschließt',
  ...
  'stdout shown to Vibe': 'stdout dem Vibe anzeigen',
  ...
  'Generate a project summary and save it to .vibe/PROJECT_SUMMARY.md':
    'Projektzusammenfassung generieren und in .vibe/PROJECT_SUMMARY.md speichern',
  ...
  'Successfully added VIBE.md files from the following directories if there are:\n- {{directories}}':
    'VIBE.md-Dateien aus folgenden Verzeichnissen erfolgreich hinzugefügt, falls vorhanden:\n- {{directories}}',
  ...
  'Run.vibe --debug to see error logs':
    'Führen Sie.vibe --debug aus, um Fehlerprotokolle anzuzeigen',
  ...
  'Vibe OAuth free tier was discontinued on 2026-04-15. Run /auth to switch provider.':
    'Das kostenlose Vibe OAuth-Kontingent wurde am 2026-04-15 eingestellt. Führen Sie /auth aus, um den Anbieter zu wechseln.',
  'Vibe OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'Das kostenlose Vibe OAuth-Kontingent wurde am 2026-04-15 eingestellt. Bitte wählen Sie Coding Plan oder API Key.',
  'Vibe OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'Das kostenlose Vibe OAuth-Angebot wurde am 2026-04-15 eingestellt. Bitte wählen Sie ein Modell eines anderen Anbieter oder führen Sie /auth aus, um zu wechseln.',
  '\n⚠ Vibe OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ Das kostenlose Vibe OAuth-Kontingent wurde am 2026-04-15 eingestellt. Bitte wählen Sie eine andere Option.\n',
  ...
  'Vibe OAuth authentication timed out. Please try again.':
    'Vibe OAuth-Authentifizierung abgelaufen. Bitte versuchen Sie es erneut.',
  'Vibe OAuth authentication cancelled.':
    'Vibe OAuth-Authentifizierung abgebrochen.',
  'Vibe OAuth Authentication': 'Vibe OAuth-Authentifizierung',
  ...
  'Vibe OAuth Authentication Timeout':
    'Vibe OAuth-Authentifizierung abgelaufen',
  ...
  'Waiting for Vibe OAuth authentication...':
    'Warten auf Vibe OAuth-Authentifizierung...',
  'Note: Your existing API key in settings.json will not be cleared when using Vibe OAuth. You can switch back to OpenAI authentication later if needed.':
    'Hinweis: Ihr bestehender API-Schlüssel in settings.json wird bei Verwendung von Vibe OAuth nicht gelöscht. Sie können später bei Bedarf zur OpenAI-Authentifizierung zurückwechseln.',
  'Note: Your existing API key will not be cleared when using Vibe OAuth.':
    'Hinweis: Ihr bestehender API-Schlüssel wird bei Verwendung von Vibe OAuth nicht gelöscht.',
  ...
  'Invalid VIBE_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Ungültiger VIBE_DEFAULT_AUTH_TYPE-Wert: "{{value}}". Gültige Werte sind: {{validValues}}',
  ...
  'Vibe 3.6 Plus — efficient hybrid model with leading coding performance':
    'Vibe 3.6 Plus — effizientes Hybridmodell mit führender Programmierleistung',
  'The latest Vibe Vision model from Alibaba Cloud ModelStudio (version:.vibe3-vl-plus-2025-09-23)':
    'Das neueste Vibe Vision Modell von Alibaba Cloud ModelStudio (Version:.vibe3-vl-plus-2025-09-23)',
  ...
  "Vibe Code won't ask before using allowed tools.":
    'Vibe Code fragt nicht, bevor erlaubte Tools verwendet werden.',
  'Vibe Code will ask before using these tools.':
    'Vibe Code fragt, bevor diese Tools verwendet werden.',
  'Vibe Code is not allowed to use denied tools.':
    'Vibe Code darf verweigerte Tools nicht verwenden.',
  ...
  'Saved in .vibe/settings.local.json':
    'Gespeichert in .vibe/settings.local.json',
  'Project settings': 'Projekteinstellungen',
  'Checked in at .vibe/settings.json': 'Eingecheckt in .vibe/settings.json',
  'User settings': 'Benutzereinstellungen',
  'Saved in at ~/.vibe/settings.json': 'Gespeichert in ~/.vibe/settings.json',
  ...
  'Vibe Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'Vibe Code kann Dateien im Arbeitsbereich lesen und Bearbeitungen vornehmen, wenn die automatische Akzeptierung aktiviert ist.',
  'Vibe Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'Vibe Code kann Dateien in diesem Verzeichnis lesen und Bearbeitungen vornehmen, wenn die automatische Akzeptierung aktiviert ist.',
  ...
  'files to customize your interactions with Vibe Code.':
    'Dateien, um Ihre Interaktionen mit Vibe Code anzupassen.',
  ...
  'You can run any shell commands from Vibe Code using ! (e.g. !ls).':
    'Sie können beliebige Shell-Befehle in Vibe Code mit ! ausführen (z. B. !ls).',
  ...
  'You can resume a previous conversation by running.vibe --continue or.vibe --resume.':
    'Sie können eine frühere Unterhaltung mit.vibe --continue oder.vibe --resume fortsetzen.',
  ...
  'Add a VIBE.md file to give Vibe Code persistent project context.':
    'Fügen Sie eine VIBE.md-Datei hinzu, um Vibe Code dauerhaften Projektkontext zu geben.',
  ...
  'Configure Vibe authentication information with Vibe-OAuth or Alibaba Cloud Coding Plan':
    'Vibe-Authentifizierung mit Vibe-OAuth oder Alibaba Cloud Coding Plan konfigurieren',
  'Authenticate using Vibe OAuth': 'Mit Vibe OAuth authentifizieren',
  ...
  'Starting Vibe OAuth authentication...':
    'Vibe OAuth-Authentifizierung wird gestartet...',
  'Successfully authenticated with Vibe OAuth.':
    'Erfolgreich mit Vibe OAuth authentifiziert.',
  'Failed to authenticate with Vibe OAuth: {{error}}':
    'Authentifizierung mit Vibe OAuth fehlgeschlagen: {{error}}',
  ...
  '  vibe auth.vibe-oauth     - Authenticate with Vibe OAuth (discontinued)':
    '  vibe auth.vibe-oauth     - Mit Vibe OAuth authentifizieren (eingestellt)',
  '  vibe auth coding-plan      - Authenticate with Alibaba Cloud Coding Plan\n':
    '  vibe auth coding-plan      - Mit Alibaba Cloud Coding Plan authentifizieren\n',
  'Or simply run:': 'Oder einfach ausführen:',
  '  vibe auth                - Interactive authentication setup\n':
    '  vibe auth                - Interaktive Authentifizierungseinrichtung\n',
  '✓ Authentication Method: Vibe OAuth':
    '✓ Authentifizierungsmethode: Vibe OAuth',
  ...
  'Vibe OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'Das kostenlose Vibe OAuth-Kontingent wurde am 2026-04-15 eingestellt. Führen Sie /auth aus, um zu Coding Plan, OpenRouter, Fireworks AI oder einem anderen Anbieter zu wechseln.',
  '  Models: Vibe latest models\n': '  Modelle: Vibe neueste Modelle\n',
  ...
  '  Run `vibe auth coding-plan` to re-configure.\n':
    '  Führen Sie `vibe auth coding-plan` aus, um neu zu konfigurieren.\n',
