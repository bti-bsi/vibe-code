...
// Chinese translations for Vibe Code CLI
...
export default {
  ...
  'for help on Vibe Code': '获取 Vibe Code 帮助',
  'show version info': '显示版本信息',
  'submit a bug report': '提交错误报告',
  'About Vibe Code': '关于 Vibe Code',
  Status: '状态',
  ...
  // ============================================================================
  'Project Level (.vibe/agents/)': '项目级 (.vibe/agents/)',
  'User Level (~/.vibe/agents/)': '用户级 (~/.vibe/agents/)',
  ...
  'Generate with Vibe Code (Recommended)': '使用 Vibe Code 生成（推荐）',
  ...
  // ============================================================================
  'View and edit Vibe Code settings': '查看和编辑 Vibe Code 设置',
  Settings: '设置',
  'To see changes, Vibe Code must be restarted. Press r to exit and apply changes now.':
    '要查看更改，必须重启 Vibe Code。按 r 退出并立即应用更改。',
  ...
  'How is Vibe doing this session? (optional)': 'Vibe 这次表现如何？（可选）',
  Bad: '不满意',
  Fine: '还行',
  Good: '满意',
  Dismiss: '忽略',
  ...
  'This extension will append info to your VIBE.md context using {{fileName}}':
    '此扩展将使用 {{fileName}} 向您的 VIBE.md 上下文追加信息',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Vibe Code.':
    '您正在安装来自 {{originSource}} 的扩展。某些功能可能无法完美兼容 Vibe Code。',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Vibe Code in one of these supported IDEs: VS Code or VS Code forks.':
    '您当前环境不支持 IDE 集成。要使用此功能，请在以下支持的 IDE 之一中运行 Vibe Code：VS Code 或 VS Code 分支版本。',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Vibe Code.':
    '此菜单为只读。要添加或修改 Hook，请直接编辑 settings.json 或询问 Vibe Code。',
  ...
  'To add hooks, edit settings.json directly or ask Vibe.':
    '要添加 Hook，请直接编辑 settings.json 或询问 Vibe。',
  ...
  'To modify or remove this hook, edit settings.json directly or ask Vibe to help.':
    '要修改或删除此 Hook，请直接编辑 settings.json 或询问 Vibe。',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Vibe Code.':
    '要重新启用 Hook，请从 settings.json 中删除 "disableAllHooks" 或询问 Vibe Code。',
  // Hooks - Source
  Project: '项目',
  User: '用户',
  System: '系统',
  ...
  'Right before Vibe Code concludes its response': 'Vibe Code 结束响应之前',
  ...
  'stdout shown to Vibe': '向 Vibe 显示 stdout',
  ...
  'Run.vibe --debug to see error logs': '运行.vibe --debug 查看错误日志',
  ...
  'Generate a project summary and save it to .vibe/PROJECT_SUMMARY.md':
    '生成项目摘要并保存到 .vibe/PROJECT_SUMMARY.md',
  ...
  'Vibe OAuth authentication timed out. Please try again.':
    'Vibe OAuth 认证超时。请重试',
  'Vibe OAuth authentication cancelled.': 'Vibe OAuth 认证已取消',
  'Vibe OAuth Authentication': 'Vibe OAuth 认证',
  ...
  'Vibe OAuth Authentication Timeout': 'Vibe OAuth 认证超时',
  'OAuth token expired (over {{seconds}} seconds). Please select authentication method again.':
    'OAuth 令牌已过期（超过 {{seconds}} 秒）。请重新选择认证方法',
  'Press any key to return to authentication type selection.':
    '按任意键返回认证类型选择',
  'Waiting for Vibe OAuth authentication...': '正在等待 Vibe OAuth 认证...',
  'Note: Your existing API key in settings.json will not be cleared when using Vibe OAuth. You can switch back to OpenAI authentication later if needed.':
    '注意：使用 Vibe OAuth 时，settings.json 中现有的 API 密钥不会被清除。如果需要，您可以稍后切换回 OpenAI 认证。',
  'Note: Your existing API key will not be cleared when using Vibe OAuth.':
    '注意：使用 Vibe OAuth 时，现有的 API 密钥不会被清除。',
  ...
  'Invalid VIBE_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    '无效的 VIBE_DEFAULT_AUTH_TYPE 值："{{value}}"。有效值为：{{validValues}}',
  ...
  'Vibe 3.6 Plus — efficient hybrid model with leading coding performance':
    'Vibe 3.6 Plus — 高效混合架构，编程性能业界领先',
  'The latest Vibe Vision model from Alibaba Cloud ModelStudio (version:.vibe3-vl-plus-2025-09-23)':
    '来自阿里云 ModelStudio 的最新 Vibe Vision 模型（版本.vibe3-vl-plus-2025-09-23）',
  ...
  'You can run any shell commands from Vibe Code using ! (e.g. !ls).':
    '在 Vibe Code 中使用 ! 可运行任意 shell 命令（例如 !ls）。',
  ...
  'You can resume a previous conversation by running.vibe --continue or.vibe --resume.':
    '运行.vibe --continue 或.vibe --resume 可继续之前的会话。',
  ...
  'Add a VIBE.md file to give Vibe Code persistent project context.':
    '添加 VIBE.md 文件，为 Vibe Code 提供持久的项目上下文。',
  ...
  // Exit Screen / Stats
  // ============================================================================
  'Agent powering down. Goodbye!': 'Vibe Code 正在关闭，再见！',
  ...
  'Configure Vibe authentication information with Vibe-OAuth or Alibaba Cloud Coding Plan':
    '使用 Vibe OAuth 或阿里云百炼 Coding Plan 配置 Vibe 认证信息',
  'Authenticate using Vibe OAuth': '使用 Vibe OAuth 进行认证',
  ...
  'Starting Vibe OAuth authentication...': '正在启动 Vibe OAuth 认证...',
  'Successfully authenticated with Vibe OAuth.': '已成功通过 Vibe OAuth 认证。',
  'Failed to authenticate with Vibe OAuth: {{error}}':
    'Vibe OAuth 认证失败：{{error}}',
  ...
  '  vibe auth.vibe-oauth     - Authenticate with Vibe OAuth (discontinued)':
    '  vibe auth.vibe-oauth     - 使用 Vibe OAuth 登录（已停用）',
  '  vibe auth coding-plan      - Authenticate with Alibaba Cloud Coding Plan\n':
    '  vibe auth coding-plan      - 使用阿里云百炼 Coding Plan 认证\n',
  'Or simply run:': '或者直接运行：',
  '  vibe auth                - Interactive authentication setup\n':
    '  vibe auth                - 交互式认证配置\n',
  '✓ Authentication Method: Vibe OAuth': '✓ 认证方式：Vibe OAuth',
  ...
  'Vibe OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'Vibe OAuth 免费额度已于 2026-04-15 停用。请运行 /auth 切换到 Coding Plan、OpenRouter、Fireworks AI 或其他服务商。',
  ...
  "Set up Vibe Code's status line UI": '配置 Vibe Code 的状态栏',
};
