...
// Traductions françaises pour Vibe Code CLI
...
export default {
  ...
  'Analyzes the project and creates a tailored VIBE.md file.':
    'Analyse le projet et crée un fichier VIBE.md personnalisé.',
  'List available Vibe Code tools. Usage: /tools [desc]':
    'Lister les outils Vibe Code disponibles. Utilisation : /tools [desc]',
  'List available skills.': 'Lister les compétences disponibles.',
  'Available Vibe Code CLI tools:': 'Outils Vibe Code CLI disponibles :',
  ...
  'open full Vibe Code documentation in your browser':
    'ouvrir la documentation complète de Vibe Code dans votre navigateur',
  ...
  // ============================================================================
  'Project Level (.vibe/agents/)': 'Niveau projet (.vibe/agents/)',
  'User Level (~/.vibe/agents/)': 'Niveau utilisateur (~/.vibe/agents/)',
  ...
  'Generate with Vibe Code (Recommended)':
    'Générer avec Vibe Code (Recommandé)',
  ...
  'View and edit Vibe Code settings':
    'Voir et modifier les paramètres de Vibe Code',
  Settings: 'Paramètres',
  'To see changes, Vibe Code must be restarted. Press r to exit and apply changes now.':
    'Pour voir les changements, Vibe Code doit être redémarré. Appuyez sur r pour quitter et appliquer les changements maintenant.',
  ...
  'How is Vibe doing this session? (optional)':
    'Comment se passe cette session avec Vibe ? (facultatif)',
  Bad: 'Mauvais',
  Fine: 'Correct',
  Good: 'Bien',
  Dismiss: 'Ignorer',
  ...
  'Respect .vibeignore': 'Respecter .vibeignore',
  ...
  'This extension will append info to your VIBE.md context using {{fileName}}':
    'Cette extension ajoutera des informations à votre contexte VIBE.md en utilisant {{fileName}}',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Vibe Code.':
    'Vous installez une extension depuis {{originSource}}. Certaines fonctionnalités peuvent ne pas fonctionner parfaitement avec Vibe Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Vibe Code in one of these supported IDEs: VS Code or VS Code forks.':
    "L'intégration IDE n'est pas prise en charge dans votre environnement actuel. Pour utiliser cette fonctionnalité, exécutez Vibe Code dans l'un des IDEs pris en charge : VS Code ou ses dérivés.",
  ...
  // Commandes - Hooks
  // ============================================================================
  'Manage Vibe Code hooks': 'Gérer les hooks Vibe Code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Vibe Code.':
    'Ce menu est en lecture seule. Pour ajouter ou modifier des hooks, éditez settings.json directement ou demandez à Vibe Code.',
  ...
  'To add hooks, edit settings.json directly or ask Vibe.':
    'Pour ajouter des hooks, éditez settings.json directement ou demandez à Vibe.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask Vibe to help.':
    'Pour modifier ou supprimer ce hook, éditez settings.json directement ou demandez à Vibe.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Vibe Code.':
    'Pour réactiver les hooks, supprimez "disableAllHooks" de settings.json ou demandez à Vibe Code.',
  Project: 'Projet',
  User: 'Utilisateur',
  System: 'Système',
  Extension: 'Extension',
  ...
  'Right before Vibe Code concludes its response':
    'Juste avant que Vibe Code conclue sa réponse',
  ...
  'stdout shown to Vibe': 'stdout affiché à Vibe',
  ...
  'Run.vibe --debug to see error logs':
    "Exécutez.vibe --debug pour voir les journaux d'erreurs",
  ...
  'Generate a project summary and save it to .vibe/PROJECT_SUMMARY.md':
    "Générer un résumé du projet et l'enregistrer dans .vibe/PROJECT_SUMMARY.md",
  ...
  'Successfully added VIBE.md files from the following directories if there are:\n- {{directories}}':
    "Fichiers VIBE.md ajoutés avec succès depuis les répertoires suivants s'ils existent :\n- {{directories}}",
  ...
  'Vibe OAuth free tier was discontinued on 2026-04-15. Run /auth to switch provider.':
    'Le niveau gratuit Vibe OAuth a été abandonné le 2026-04-15. Exécutez /auth pour changer de fournisseur.',
  'Vibe OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'Le niveau gratuit Vibe OAuth a été abandonné le 2026-04-15. Veuillez sélectionner Coding Plan ou API Key.',
  'Vibe OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    "Le niveau gratuit de Vibe OAuth a été abandonné le 2026-04-15. Veuillez sélectionner un modèle d'un autre fournisseur ou exécuter /auth pour changer.",
  '\n⚠ Vibe OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ Le niveau gratuit Vibe OAuth a été abandonné le 2026-04-15. Veuillez sélectionner une autre option.\n',
  ...
  'Vibe OAuth authentication timed out. Please try again.':
    "L'authentification Vibe OAuth a expiré. Veuillez réessayer.",
  'Vibe OAuth authentication cancelled.':
    'Authentification Vibe OAuth annulée.',
  'Vibe OAuth Authentication': 'Authentification Vibe OAuth',
  ...
  'Vibe OAuth Authentication Timeout': "Délai d'authentification Vibe OAuth",
  ...
  'Waiting for Vibe OAuth authentication...':
    "En attente de l'authentification Vibe OAuth...",
  'Note: Your existing API key in settings.json will not be cleared when using Vibe OAuth. You can switch back to OpenAI authentication later if needed.':
    "Remarque : Votre clé API existante dans settings.json ne sera pas effacée lors de l'utilisation de Vibe OAuth. Vous pouvez revenir à l'authentification OpenAI plus tard si nécessaire.",
  'Note: Your existing API key will not be cleared when using Vibe OAuth.':
    "Remarque : Votre clé API existante ne sera pas effacée lors de l'utilisation de Vibe OAuth.",
  ...
  'Invalid VIBE_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Valeur VIBE_DEFAULT_AUTH_TYPE invalide : "{{value}}". Valeurs valides : {{validValues}}',
  ...
  'Vibe 3.6 Plus — efficient hybrid model with leading coding performance':
    'Vibe 3.6 Plus — modèle hybride efficace avec des performances de codage de pointe',
  'The latest Vibe Vision model from Alibaba Cloud ModelStudio (version:.vibe3-vl-plus-2025-09-23)':
    "Le dernier modèle Vibe Vision d'Alibaba Cloud ModelStudio (version :.vibe3-vl-plus-2025-09-23)",
  ...
  "Vibe Code won't ask before using allowed tools.":
    "Vibe Code ne demandera pas avant d'utiliser les outils autorisés.",
  'Vibe Code will ask before using these tools.':
    "Vibe Code demandera avant d'utiliser ces outils.",
  'Vibe Code is not allowed to use denied tools.':
    "Vibe Code n'est pas autorisé à utiliser les outils refusés.",
  ...
  'Saved in .vibe/settings.local.json':
    'Enregistré dans .vibe/settings.local.json',
  'Project settings': 'Paramètres du projet',
  'Checked in at .vibe/settings.json': 'Validé dans .vibe/settings.json',
  'User settings': 'Paramètres utilisateur',
  'Saved in at ~/.vibe/settings.json': 'Enregistré dans ~/.vibe/settings.json',
  ...
  'Vibe Code can read files in the workspace, and make edits when auto-accept edits is on.':
    "Vibe Code peut lire les fichiers dans l'espace de travail et effectuer des modifications lorsque l'acceptation automatique est activée.",
  'Vibe Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    "Vibe Code pourra lire les fichiers dans ce répertoire et effectuer des modifications lorsque l'acceptation automatique est activée.",
  ...
  'You can run any shell commands from Vibe Code using ! (e.g. !ls).':
    "Vous pouvez exécuter n'importe quelle commande shell depuis Vibe Code en utilisant ! (ex. !ls).",
  ...
  'You can resume a previous conversation by running.vibe --continue or.vibe --resume.':
    'Vous pouvez reprendre une conversation précédente en exécutant.vibe --continue ou.vibe --resume.',
  ...
  'Configure Vibe authentication information with Vibe-OAuth or Alibaba Cloud Coding Plan':
    "Configurer les informations d'authentification Vibe avec Vibe-OAuth ou Alibaba Cloud Coding Plan",
  'Authenticate using Vibe OAuth': 'Authentifier avec Vibe OAuth',
  ...
  'Starting Vibe OAuth authentication...':
    "Démarrage de l'authentification Vibe OAuth...",
  'Successfully authenticated with Vibe OAuth.':
    'Authentification réussie avec Vibe OAuth.',
  'Failed to authenticate with Vibe OAuth: {{error}}':
    "Échec de l'authentification avec Vibe OAuth : {{error}}",
  ...
  '  vibe auth.vibe-oauth     - Authenticate with Vibe OAuth (discontinued)':
    '  vibe auth.vibe-oauth     - Authentification avec Vibe OAuth (abandonné)',
  '  vibe auth coding-plan      - Authenticate with Alibaba Cloud Coding Plan\n':
    '  vibe auth coding-plan      - Authentifier avec Alibaba Cloud Coding Plan\n',
  'Or simply run:': 'Ou simplement exécutez :',
  '  vibe auth                - Interactive authentication setup\n':
    "  vibe auth                - Configuration d'authentification interactive\n",
  '✓ Authentication Method: Vibe OAuth':
    "✓ Méthode d'authentification : Vibe OAuth",
  ...
  'Vibe OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'Le niveau gratuit Vibe OAuth a été abandonné le 2026-04-15. Exécutez /auth pour passer à Coding Plan, OpenRouter, Fireworks AI ou un autre fournisseur.',
  '  Models: Vibe latest models\n': '  Modèles : Derniers modèles Vibe\n',
  ...
  '  Run `vibe auth coding-plan` to re-configure.\n':
    '  Exécutez `vibe auth coding-plan` pour reconfigurer.\n',
  ...
  "Set up Vibe Code's status line UI":
    "Configurer l'interface de la barre de statut de Vibe Code",
};
