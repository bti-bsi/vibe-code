...
// Japanese translations for Vibe Code CLI
...
export default {
  ...
  'for help on Vibe Code': 'Vibe Code のヘルプ',
  'show version info': 'バージョン情報を表示',
  'submit a bug report': 'バグレポートを送信',
  'About Vibe Code': 'Vibe Code について',
  ...
  'Analyzes the project and creates a tailored VIBE.md file.':
    'プロジェクトを分析し、カスタマイズされた VIBE.md ファイルを作成',
  'List available Vibe Code tools. Usage: /tools [desc]':
    '利用可能な Vibe Code ツールを一覧表示。使い方: /tools [desc]',
  'List available skills.': '利用可能なスキルを一覧表示する。',
  'Available Vibe Code CLI tools:': '利用可能な Vibe Code CLI ツール:',
  ...
  'Project Level (.vibe/agents/)': 'プロジェクトレベル (.vibe/agents/)',
  'User Level (~/.vibe/agents/)': 'ユーザーレベル (~/.vibe/agents/)',
  ...
  'Generate with Vibe Code (Recommended)': 'Vibe Code で生成(推奨)',
  ...
  'To see changes, Vibe Code must be restarted. Press r to exit and apply changes now.':
    '変更を確認するには Vibe Code を再起動する必要があります。 r を押して終了し、変更を適用してください',
  'The command "/{{command}}" is not supported in non-interactive mode.':
    'コマンド "/{{command}}" は非対話モードではサポートされていません',
  'View and edit Vibe Code settings': 'Vibe Code の設定を表示・編集',
  Settings: '設定',
  'Vim Mode': 'Vim モード',
  ...
  'Respect .vibeignore': '.vibeignore を優先',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Vibe Code.':
    '{{originSource}} から拡張機能をインストールしています。一部の機能は Vibe Code で完全に動作しない可能性があります。',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Vibe Code in one of these supported IDEs: VS Code or VS Code forks.':
    '現在の環境ではIDE連携はサポートされていません。この機能を使用するには、VS Code または VS Code 派生エディタで Vibe Code を実行してください',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage Vibe Code hooks': 'Vibe Code のフックを管理する',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Vibe Code.':
    'このメニューは読み取り専用です。フックを追加または変更するには、settings.json を直接編集するか、Vibe Code に尋ねてください。',
  ...
  'To add hooks, edit settings.json directly or ask Vibe.':
    'フックを追加するには、settings.json を直接編集するか、Vibe に尋ねてください。',
  ...
  'To modify or remove this hook, edit settings.json directly or ask Vibe to help.':
    'このフックを変更または削除するには、settings.json を直接編集するか、Vibe に尋ねてください。',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Vibe Code.':
    'フックを再有効化するには、settings.json から "disableAllHooks" を削除するか、Vibe Code に尋ねてください。',
  // Hooks - Source
  Project: 'プロジェクト',
  User: 'ユーザー',
  System: 'システム',
  ...
  'stdout shown to Vibe': 'stdout をモデルに表示',
  ...
  'Generate a project summary and save it to .vibe/PROJECT_SUMMARY.md':
    'プロジェクトサマリーを生成し、.vibe/PROJECT_SUMMARY.md に保存',
  ...
  'Successfully added VIBE.md files from the following directories if there are:\n- {{directories}}':
    '以下のディレクトリから VIBE.md ファイルを追加しました(存在する場合):\n- {{directories}}',
  ...
  'Vibe OAuth authentication timed out. Please try again.':
    'Vibe OAuth認証がタイムアウトしました。再度お試しください',
  'Vibe OAuth authentication cancelled.':
    'Vibe OAuth認証がキャンセルされました',
  'Vibe OAuth Authentication': 'Vibe OAuth認証',
  ...
  'Vibe OAuth Authentication Timeout': 'Vibe OAuth認証タイムアウト',
  'OAuth token expired (over {{seconds}} seconds). Please select authentication method again.':
    'OAuthトークンが期限切れです({{seconds}}秒以上)。認証方法を再度選択してください',
  'Press any key to return to authentication type selection.':
    '認証タイプ選択に戻るには任意のキーを押してください',
  'Waiting for Vibe OAuth authentication...': 'Vibe OAuth認証を待っています...',
  'Note: Your existing API key in settings.json will not be cleared when using Vibe OAuth. You can switch back to OpenAI authentication later if needed.':
    '注: Vibe OAuthを使用しても、settings.json内の既存のAPIキーはクリアされません。必要に応じて後でOpenAI認証に切り替えることができます',
  'Note: Your existing API key will not be cleared when using Vibe OAuth.':
    '注: Vibe OAuthを使用しても、既存のAPIキーはクリアされません。',
  ...
  'Invalid VIBE_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    '無効な VIBE_DEFAULT_AUTH_TYPE 値: "{{value}}"。有効な値: {{validValues}}',
  ...
  'Vibe 3.6 Plus — efficient hybrid model with leading coding performance':
    'Vibe 3.6 Plus — 効率的なハイブリッドモデル、業界トップクラスのコーディング性能',
  'The latest Vibe Vision model from Alibaba Cloud ModelStudio (version:.vibe3-vl-plus-2025-09-23)':
    'Alibaba Cloud ModelStudioの最新Vibe Visionモデル(バージョン:.vibe3-vl-plus-2025-09-23)',
  // Dialogs - Permissions
  ...
  "Vibe Code won't ask before using allowed tools.":
    'Vibe Code は許可されたツールを使用する前に確認しません。',
  'Vibe Code will ask before using these tools.':
    'Vibe Code はこれらのツールを使用する前に確認します。',
  'Vibe Code is not allowed to use denied tools.':
    'Vibe Code は拒否されたツールを使用できません。',
  ...
  'Saved in .vibe/settings.local.json': '.vibe/settings.local.json に保存',
  'Project settings': 'プロジェクト設定',
  'Checked in at .vibe/settings.json': '.vibe/settings.json にチェックイン',
  'User settings': 'ユーザー設定',
  'Saved in at ~/.vibe/settings.json': '~/.vibe/settings.json に保存',
  ...
  'Vibe Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'Vibe Code はワークスペース内のファイルを読み取り、自動編集承認が有効な場合は編集を行えます。',
  'Vibe Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'Vibe Code はこのディレクトリ内のファイルを読み取り、自動編集承認が有効な場合は編集を行えます。',
  ...
  'You can run any shell commands from Vibe Code using ! (e.g. !ls).':
    'Vibe Code から ! を使って任意のシェルコマンドを実行できます（例: !ls）。',
  ...
  'Add a VIBE.md file to give Vibe Code persistent project context.':
    'VIBE.md ファイルを追加すると、Vibe Code に永続的なプロジェクトコンテキストを与えられます。',
  ...
  'files to customize your interactions with Vibe Code.':
    'Vibe Code との対話をカスタマイズするためのファイル',
  ...
  'Configure Vibe authentication information with Vibe-OAuth or Alibaba Cloud Coding Plan':
    'Vibe-OAuth または Alibaba Cloud Coding Plan で Vibe 認証情報を設定する',
  'Authenticate using Vibe OAuth': 'Vibe OAuth で認証する',
  ...
  'Starting Vibe OAuth authentication...': 'Vibe OAuth 認証を開始しています...',
  'Successfully authenticated with Vibe OAuth.':
    'Vibe OAuth での認証に成功しました。',
  'Failed to authenticate with Vibe OAuth: {{error}}':
    'Vibe OAuth での認証に失敗しました: {{error}}',
  ...
  '  vibe auth.vibe-oauth     - Authenticate with Vibe OAuth (discontinued)':
    '  vibe auth.vibe-oauth     - Vibe OAuth で認証（終了）',
  '  vibe auth coding-plan      - Authenticate with Alibaba Cloud Coding Plan\n':
    '  vibe auth coding-plan      - Alibaba Cloud Coding Plan で認証\n',
  'Or simply run:': 'または以下を実行:',
  '  vibe auth                - Interactive authentication setup\n':
    '  vibe auth                - インタラクティブ認証セットアップ\n',
  '✓ Authentication Method: Vibe OAuth': '✓ 認証方法: Vibe OAuth',
  ...
  'Vibe OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'Vibe OAuth 無料枠は 2026-04-15 に終了しました。/auth を実行して Coding Plan、OpenRouter、Fireworks AI、または他のプロバイダーに切り替えてください。',
  ...
  '  Run `vibe auth coding-plan` to re-configure.\n':
    '  `vibe auth coding-plan` を実行して再設定してください。\n',
