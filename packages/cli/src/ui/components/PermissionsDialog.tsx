  ...
  return [
    {
      ...
      description: t('Checked in at .vibe/settings.json'),
      value: SettingScope.Workspace,
      key: 'project',
    },
    {
      label: t('User settings'),
      description: t('Saved in at ~/.vibe/settings.json'),
  ...
  return [
    {
      id: 'allow',
      label: t('Allow'),
      description: t("Vibe Code won't ask before using allowed tools."),
    },
    {
      id: 'ask',
      label: t('Ask'),
      description: t('Vibe Code will ask before using these tools.'),
    },
    {
      id: 'deny',
      label: t('Deny'),
      description: t('Vibe Code is not allowed to use denied tools.'),
    },
    {
      id: 'workspace',
      label: t('Workspace'),
