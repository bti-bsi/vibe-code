...
describe('ManageModelsDialog helpers', () => {
  it('buildModelLabel uses the short display label only', () => {
    expect(
      buildModelLabel(
        makeEntry('vibe/vibe3-coder:free', {
          badges: ['free', 'vision'],
          contextWindowSize: 1_000_000,
        }),
      ),
    ).toBe('vibe/vibe3-coder:free');
  });

  it.each<[FilterMode, string[]]>([
    ['all', ['vibe/vibe3-coder:free', 'openai/gpt-4o-mini']],
    ['enabled', ['openai/gpt-4o-mini']],
    ['free', ['vibe/vibe3-coder:free']],
    ['vision', ['vibe/vibe3-coder:free']],
