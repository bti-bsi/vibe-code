...
describe('HookConfigDetailStep', () => {
  const createMockHookEvent = (): HookEventDisplayInfo => ({
    ...
    shortDescription: 'Right before Vibe Code concludes its response',
    description: '',
    exitCodes: [
  ...
  it('should render source for Extensions with path', () => {
    ...
    const hookConfig = createMockHookConfig(
      ...
      'ralph-wiggum',
      '/Users/test/.vibe/extensions/ralph-wiggum',
    );
    ...
    expect(lastFrame()).toContain('/Users/test/.vibe/extensions/ralph-wiggum');
  });
