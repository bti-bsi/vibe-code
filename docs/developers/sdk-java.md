...
<dependency>
    ...
    <artifactId>vibecode-sdk</artifactId>
...
```gradle
implementation 'com.alibaba:vibecode-sdk:{$version}'
```
...
The simplest way to use the SDK is through the `VibeCodeCli.simpleQuery()` method:
...
public static void runTransportOptionsExample() {
    ...
    List<String> result = VibeCodeCli.simpleQuery("who are you, what are your capabilities?", options);
    result.forEach(logger::info);
}
```
...
public static void runStreamingExample() {
    VibeCodeCli.simpleQuery("who are you, what are your capabilities?",
...
other examples see src/test/java/com/alibaba/vibe/code/cli/example
...
A: yes, requires Vibe CLI 0.5.5 or higher.
