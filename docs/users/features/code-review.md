...
- Model attribution footer on each comment (e.g., _— vibe3-coder via Vibe Code /review_)
...
1. `.vibe/review-rules.md` (Vibe Code native)
...
/review 123
# → "Previous review used vibe3-coder. Running full review with gpt-4o for a second opinion."
```
...
```
.vibe/reviews/2026-04-06-143022-pr-123.md
.vibe/reviews/2026-04-06-150510-local.md
```
